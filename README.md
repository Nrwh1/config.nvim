...
```sh
git clone https://github.com/Nrwh1/config.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/Nrwh1/config.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/Nrwh1/config.nvim.git "${env:LOCALAPPDATA}\nvim"
```
